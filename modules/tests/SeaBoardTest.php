...
final class SeaBoardTest extends TestCase
{
    ...
    public function testPushObjectInDirection(): void
    {
        ...
        $result = $this->seaBoard->pushObjectInDirection("player_ship", "player1", Heading::EAST, [
            "rock",
            "player_ship",
        ]);
    ...
    public function testGustPushesShip(): void
    {
        ...
        $result = $this->seaBoard->pushObjectInDirection("player_ship", "player1", $gustAtLocation["heading"], [
            "rock",
            "player_ship",
        ]);
