...
final class BootyPaymentTest extends TestCase
{
    ...
    public function testResolveAllFixedExcess(): void
    {
        ...
        $result = $this->game->callResolveBootyResources(["sail" => 3], ["sail" => 1]);
        $this->assertEquals(3, $result["sail"]);
    }

    public function testResolveFixedNoOverlapWithCost(): void
    {
        $result = $this->game->callResolveBootyResources(["sail" => 2], ["cannonball" => 3]);
    ...
    public function testResolveChoiceAutoAssignsToHighestNeed(): void
    {
        ...
        $result = $this->game->callResolveBootyResources(["choice" => 1], ["sail" => 3, "cannonball" => 1]);
        $this->assertEquals(1, $result["sail"]);
        $this->assertArrayNotHasKey("cannonball", $result);
    }
    ...
    public function testResolveMultipleChoiceUnitsSpreadAcross(): void
    {
        ...
        //   → out['cannonball'] = 1
        $result = $this->game->callResolveBootyResources(["choice" => 2], ["sail" => 1, "cannonball" => 1]);
    ...
    {
        $result = $this->game->callResolveBootyResources(["choice" => 1], []);
    ...
    public function testResolveChoiceWhenAllNeedsCoveredIsWasted(): void
    {
        ...
        $result = $this->game->callResolveBootyResources(["doubloon" => 2, "choice" => 1], ["doubloon" => 1]);
    ...
    {
        $rem = $this->computeRemainingCost(["sail" => 1, "cannonball" => 1], ["sail" => 1, "cannonball" => 1]);
    ...
    {
        $rem = $this->computeRemainingCost(["sail" => 3, "cannonball" => 2], ["sail" => 1]);
    ...
    {
        $rem = $this->computeRemainingCost(["sail" => 1], ["sail" => 3]);
        $this->assertEquals(0, $rem["sail"]);
    }

    public function testCostReductionWrongResourceType(): void
    {
        $rem = $this->computeRemainingCost(["cannonball" => 2], ["sail" => 2]);
        $this->assertEquals(2, $rem["cannonball"]);
    }
