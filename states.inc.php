...
// State machine is now defined via State classes in modules/php/States/.
// The $machinestates array is left empty; the BGA framework discovers states from the State classes.
$machinestates = [];
